            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">Satkai</th>
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='80' height='13' align='center' valign='middle'>$data[no_sput]</td>
                        <td width='80' height='13' align='center' valign='middle'>$tanggal_keluar</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[satkai]</td>
                        ...
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[jenis]</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[kaliber]</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[negara]</td>
