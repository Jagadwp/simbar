      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Selamat datang <strong><?php echo $_SESSION['nama_user']; ?></strong> di Aplikasi Sistem Informasi Management Bekal Kelas V - ARSENAL.
          </p>        
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          <div class="inner">
            ...
            <p>Input Data Material Isian Gudang</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#f39c12;color:#fff" class="small-box">
          <div class="inner">
            ...
            ?>
            <h3><?php echo $data['jumlah']; ?></h3>
            <p>Laporan Stock Akhir Material</p>
          </div>
          <div class="icon">
