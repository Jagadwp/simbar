...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | SIMBAR Ver.1</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Sistim Informasi Isian Gudang">
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-80px" src="assets/img/AR1.png" alt="Logo" height="200"> 
      </div>
      <div style="color:#00008b" class="login-logo">
          <b>Sistem Informasi Management Bekal Kelas V ARSENAL</b>
      </div>
      <div style="color:#3c8dbc" class="login-logo">
          <b>SIMBAR Ver.1</b>
      </div><!-- /.login-logo -->
