...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | SIMBAR Ver.1</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Sistem informasi isian gudang penyimpanan">
    <meta name="author" content="Bambang Harjanto" />
    
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/pan1.jpg" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-10px;margin-right:5px" src="assets/img/AR2.png" alt="Logo"> 
          <span style="font-size:20px">SIMBAR Ver.1</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2024 - <a href="https://textcode.blogspot.com">Mayor Laut (E) Bambang Harjanto, SE</a></strong>
      </footer>
    </div><!-- ./wrapper -->
